...
public class AdminController {
	 ...
	 @DeleteMapping("/listUsers/removeUser")
	    ...
	    public String makeTournament(@ModelAttribute("tournament") Tournament tournament,@RequestParam("water") long water,@RequestParam("fish")long fish, @RequestParam("days")  int days) {
